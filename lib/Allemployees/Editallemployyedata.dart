...
class EditAllemployeesscreen extends StatefulWidget {
  final String documentId;
  final String imageurl;

  const EditAllemployeesscreen({Key? key, required this.documentId, required this.imageurl})
      : super(key: key);

  @override
  _EditAllemployeesscreenState createState() => _EditAllemployeesscreenState();
}

class _EditAllemployeesscreenState extends State<EditAllemployeesscreen> {
  List<String> items = [
    'Department',
    'Digital Marketing',
    'App Development',
