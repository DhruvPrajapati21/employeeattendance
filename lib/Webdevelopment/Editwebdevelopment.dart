...
class Editwebdevelopmentscreen extends StatefulWidget {
  final String documentId;
  final String imageurl;

  const Editwebdevelopmentscreen({Key? key, required this.documentId, required this.imageurl})
      : super(key: key);

  @override
  _EditwebdevelopmentscreenState createState() => _EditwebdevelopmentscreenState();
}

class _EditwebdevelopmentscreenState extends State<Editwebdevelopmentscreen> {
  List<String> items = [
    'Department',
    'Digital Marketing',
    'App Development',
