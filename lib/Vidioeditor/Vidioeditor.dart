...
import 'Editvidioeditor.dart';

class VidioEditor extends StatefulWidget {
  @override
  _VidioEditorState createState() => _VidioEditorState();
}

class _VidioEditorState extends State<VidioEditor> {
                        ...
                        IconButton(
                          ...
                          onPressed: () async {
                            ...
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => Editvidioeditorscreen(
