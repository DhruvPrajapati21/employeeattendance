...
class Editvidioeditorscreen extends StatefulWidget {
  final String documentId;
  final String imageurl;

  const Editvidioeditorscreen({Key? key, required this.documentId, required this.imageurl})
      : super(key: key);

  @override
  _EditvidioeditorscreenState createState() => _EditvidioeditorscreenState();
}

class _EditvidioeditorscreenState extends State<Editvidioeditorscreen> {
  List<String> items = [
    'Department',
    'Digital Marketing',
    'App Development',
