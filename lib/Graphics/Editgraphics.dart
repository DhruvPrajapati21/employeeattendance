...
class Editgraphicsscreen extends StatefulWidget {
  final String documentId;
  final String imageurl;

  const Editgraphicsscreen({Key? key, required this.documentId, required this.imageurl})
      : super(key: key);

  @override
  _EditgraphicsscreenState createState() => _EditgraphicsscreenState();
}

class _EditgraphicsscreenState extends State<Editgraphicsscreen> {
  List<String> items = [
    'Department',
    'Digital Marketing',
    'App Development',
