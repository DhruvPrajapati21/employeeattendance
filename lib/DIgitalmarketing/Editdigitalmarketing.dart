...
class EditDigitalmarketingscreen extends StatefulWidget {
  final String documentId;
  final String imageurl;

  const EditDigitalmarketingscreen({Key? key, required this.documentId, required this.imageurl})
      : super(key: key);

  @override
  _EditDigitalmarketingscreenState createState() => _EditDigitalmarketingscreenState();
}

class _EditDigitalmarketingscreenState extends State<EditDigitalmarketingscreen> {
  List<String> items = [
    'Department',
    'Digital Marketing',
    'App Development',
    ...
    try {
      ...
      switch (selectedDepartment) {
        ...
        case 'App Development':
          Navigator.pushReplacement(
              context, MaterialPageRoute(builder: (context) => Appdevelopment()));
          break;
        case 'Video Editor':
          Navigator.pushReplacement(
