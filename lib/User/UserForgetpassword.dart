...
import 'package:fbserviceauthentication/User/Usersignup.dart';
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    ...
                    width: 280,
                    color: Colors.cyan,
                    child:  Center(child: Text("Employee Forgetpassword",style:TextStyle(fontStyle: FontStyle.italic,fontWeight: FontWeight.bold,color: Colors.white, fontSize: 20,),)),
                  ),
                  SizedBox(height: 20,),
                  Padding(
